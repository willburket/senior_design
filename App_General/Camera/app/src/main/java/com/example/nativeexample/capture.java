...
public class capture extends AppCompatActivity {
    ...
    private DisparityTransformFilter mDisparityTransform;
    ...
    private void init(){
      ...
      //  mDisparityTransform = new DisparityTransformFilter();
      //  mDisparityTransform = new DisparityTransformFilter(false);
